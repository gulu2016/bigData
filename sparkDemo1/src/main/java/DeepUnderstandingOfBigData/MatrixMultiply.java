package DeepUnderstandingOfBigData;

/**
 * @ProjectName: scalaWordCount
 * @Package: DeepUnderstandingOfBigData
 * @ClassName: MatrixMultiply
 * @Description: mapreduce实现矩阵乘法(暂时还有问题)
 * @Author: gulu
 * @CreateDate: 19-2-15 上午8:44
 * @UpdateUser: 更新者
 * @UpdateDate: 19-2-15 上午8:44
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class MatrixMultiply {
    ...
    public static void main(String[] args) throws IOException,
        ...
        String input1 = "hdfs://localhost:9000/home/zhangjiaqian/test/ma";
        String input2 = "hdfs://localhost:9000/home/zhangjiaqian/test/mb";
        String output = "hdfs://localhost:9000/home/zhangjiaqian/test/out";

        Configuration conf = new Configuration();
        conf.addResource("classpath:/usr/local/hadoop/etc/hadoop/core-site.xml");
        conf.addResource("classpath:/usr/local/hadoop/etc/hadoop/hdfs-site.xml");
        conf.addResource("classpath:/usr/local/hadoop/etc/hadoop/mapred-site.xml");
        conf.addResource("classpath:/usr/local/hadoop/etc/hadoop/yarn-site.xml");
